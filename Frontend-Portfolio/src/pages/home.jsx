                ...
                <div className="container">
                    <div className="home__content">
                        <div className="home__content--left">
                            ...
                            <p className="home__description">Développeur full-stack passionné par la création d'applications 
                                web modernes. Je travaille principalement avec React, Node.js et Laravel pour concevoir des 
                                plateformes performantes, évolutives et bien architecturées. J'accorde une grande importance 
