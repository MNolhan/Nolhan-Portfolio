    ...
    return (
        <dialog className="panel panel--popup" id="DeleteProject">
            ...
            <form className="panel__content" onSubmit={handleSubmit}>
                ...
                <input className="input" placeholder="Nom du Projet" value={name} onChange={(e) => setName(e.target.value)}></input>

                {message && <p className="panel__message">{message}</p>}

                <div className="panel__buttons">
                    <Bouton variant="secondary" type="submit">Supprimer</Bouton>
